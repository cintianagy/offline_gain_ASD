...
# t-test
t.test(SL_score ~ Group, data = study2_SL_long, var.equal = T)
...
# t-test
t.test(VP_score ~ Group, data = study2_VP_long, var.equal = T)
...
# t-test
t.test(SL_score ~ Group, data = study1_SL_long, var.equal = T)
...
# t-test
t.test(VP_score ~ Group, data = study1_VP_long, var.equal = T)
