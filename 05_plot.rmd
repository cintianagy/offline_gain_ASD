...
ggplot(study1_general, aes(x = AQ_total)) +
  geom_histogram(binwidth = 1, colour="black", fill = "#9E7B9B") +
...
```{r}
ggplot(study1_SL_long, aes(x = Learning_phase, y = SL_score, fill = factor(Group, levels = c("lower AQ", "higher AQ"))), show.legend = FALSE) +
  ...
  scale_x_discrete(labels = "offline") +
  theme_classic() +
  labs(fill = "Group")
...
```{r}
ggplot(study1_VP_long, aes(x = Learning_phase, y = VP_score, fill = factor(Group, levels = c("lower AQ", "higher AQ"))), show.legend = FALSE) +
  geom_flat_violin(aes(fill = factor(Group, levels = c("lower AQ", "higher AQ"))), position = position_nudge(x = .1, y = 0), adjust = 1.5, trim = FALSE, alpha = .5, colour = NA, show.legend = TRUE) +
  geom_point(aes(x = as.numeric(Learning_phase) - .15, colour = factor(Group, levels = c("lower AQ", "higher AQ"))), position = position_jitter(width = .05), size = 1, shape = 20, show.legend = FALSE) +
  geom_boxplot(aes(x = Learning_phase, y = VP_score, fill = factor(Group, levels = c("lower AQ", "higher AQ"))),outlier.shape = NA, alpha = .5, width = .1, colour = "black", show.legend = FALSE) +
  scale_colour_brewer(palette = "Dark2") +
  scale_fill_brewer(palette = "Dark2") +
  xlab("Learning phase") +
  ylab("Mean visuomotor performance change (ms)") +
  scale_x_discrete(labels = "offline") +
  theme_classic() +
  labs(fill = "Group")

#ggsave("raincloud_study1_VP.png")
```

### statistical learning & visuomotor performance

```{r}
ggplot(study1_SL_VP_long, aes(x = Learning_type, y = Learning_score, fill = factor(Group, levels = c("lower AQ", "higher AQ"))), show.legend = FALSE) +
  geom_flat_violin(aes(fill = factor(Group, levels = c("lower AQ", "higher AQ"))), position = position_nudge(x = .1, y = 0), adjust = 1.5, trim = FALSE, alpha = .5, colour = NA, show.legend = TRUE) +
  geom_point(aes(x = as.numeric(Learning_type) - .15, colour = factor(Group, levels = c("lower AQ", "higher AQ"))), position = position_jitter(width = .05), size = 1, shape = 20, show.legend = FALSE) +
  geom_boxplot(aes(x = Learning_type, y = Learning_score, fill = factor(Group, levels = c("lower AQ", "higher AQ"))),outlier.shape = NA, alpha = .5, width = .1, colour = "black", show.legend = FALSE) +
  scale_colour_brewer(palette = "Dark2") +
  scale_fill_brewer(palette = "Dark2") +
  xlab("Learning type") +
...
#ggsave("raincloud_study1_SL_VP_group.png")
```
```{r}
ggplot(study1_SL_VP_long, aes(x = Learning_type, y = Learning_score), show.legend = FALSE) +
  ...
  scale_colour_gradient(low = "#1B9E77", high = "#D95F02") +
...
```{r}
ggplot(study2_VP_long, aes(x = Learning_phase, y = VP_score, fill = factor(Group, levels = c("NTP", "ASD"))), show.legend = FALSE) +
  geom_flat_violin(aes(fill = factor(Group, levels = c("NTP", "ASD"))), position = position_nudge(x = .1, y = 0), adjust = 1.5, trim = FALSE, alpha = .5, colour = NA, show.legend = TRUE) +
  geom_point(aes(x = as.numeric(Learning_phase) - .15, colour = factor(Group, levels = c("NTP", "ASD"))), position = position_jitter(width = .05),size = 1, shape = 20, show.legend = FALSE) +
  geom_boxplot(aes(x = Learning_phase, y = VP_score, fill = factor(Group, levels = c("NTP", "ASD"))),outlier.shape = NA, alpha = .5, width = .1, colour = "black", show.legend = FALSE) +
  scale_colour_brewer(palette = "Dark2") +
  scale_fill_brewer(palette = "Dark2") +
  xlab("Learning phase") +
  ylab("Mean visuomotor performance change (ms)") +
...
#ggsave("raincloud_study2_VP.png")
```
...
ggplot(study1_visuomotor_perf_long, aes(x = as.numeric(Block), y = rt, color = as.factor(Group))) +
  ...
  scale_color_brewer(palette = "Dark2", labels = c("lower AQ", "higher AQ")) +
  theme_classic()
...
ggplot(study2_visuomotor_perf_long, aes(x = as.numeric(Block), y = rt, color = as.factor(Group))) +
  ...
  scale_x_continuous(labels = c("1" = "1-5", "2" = "5-10", "3" = "11-15", "4" = "16-20")) +
  labs(x = "Blocks", y = "Reaction time (ms)", color = "Group") +
  scale_color_brewer(palette = "Dark2", labels = c("NTP", "ASD")) +
  theme_classic()
