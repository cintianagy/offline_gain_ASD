...
```{r}
study2_bayes_SL <- extractBF(ttestBF(study2_SL_long$SL_score[study2_SL_long$Group == 0], study2_SL_long$SL_score[study2_SL_long$Group == 1]))$bf

# BF_exclusion
1/as.numeric(study2_bayes_SL)
```
...
```{r}
study2_bayes_VP <- extractBF(ttestBF(study2_VP_long$VP_score[study2_VP_long$Group == 0], study2_VP_long$VP_score[study2_VP_long$Group == 1]))$bf

# BF_exclusion
1/as.numeric(study2_bayes_VP)
```
